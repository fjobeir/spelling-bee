...
const Modal: FC<ModalProps> = ({ title, children, actions, onClose }) => {
    ...
    return (
        <>
            ...
            <div className="fixed w-96 md:w-1/2 max-w-full z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border border-solid border-gray-300 rounded-lg overflow-hidden drop-shadow-md bg-white ">
